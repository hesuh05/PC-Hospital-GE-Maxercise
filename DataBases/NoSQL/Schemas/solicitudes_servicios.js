...
SolicitudServicioSchema.index({ folio: 1 }, { unique: true });
SolicitudServicioSchema.index({ estatus: 1 });
...
export default mongoose.model("SolicitudServicio", SolicitudServicioSchema);